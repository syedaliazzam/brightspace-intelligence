...
export default function SuperAdminInterestedStudentsPage() {
  ...
  return (
    <div id="coordinator-page-portal-root" className="min-h-screen space-y-6 bg-[#FAF7F0]">
        ...
        <section className="relative overflow-hidden rounded-[2rem] border border-[#2D8A6A]/15 bg-[linear-gradient(135deg,rgba(13,59,46,0.98),rgba(13,92,72,0.94))] p-6 text-[#FAF7F0] shadow-[0_24px_80px_-36px_rgba(13,59,46,0.32)] sm:p-8">
          ...
          <div className="relative">
            ...
            <p className="mt-3 text-sm leading-7 text-[#EAF6EF] sm:text-base">
              Review interested student submissions and send admission forms from the super admin portal.
            </p>
          </div>
        </section>
