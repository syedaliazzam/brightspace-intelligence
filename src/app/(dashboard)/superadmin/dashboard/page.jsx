...
const CACHE_KEY = "superadmin-dashboard-stats:v1";
...
async function fetchDashboardStats() {
  if (!pendingDashboardRequest) {
    pendingDashboardRequest = fetch("/api/admin/stats", { cache: "no-store" })
      .then(async (response) => {
      ...
      <div className="relative mx-auto max-w-7xl space-y-6 px-4 py-5 sm:px-6 lg:px-8">
        ...
        {state.loading ? (
          <OpenBookLoader
            ...
            subtitle="Preparing super admin insights..."
          />
        ) : null}
            ...
            <div className="mb-4 flex items-center justify-between gap-4">
              <div>
                ...
                <h2 className="mt-2 font-body text-2xl font-semibold tracking-tight text-[#063F32]">
                  Active super admin role coverage
                </h2>
              </div>
            </div>
            <AdminDataTable
