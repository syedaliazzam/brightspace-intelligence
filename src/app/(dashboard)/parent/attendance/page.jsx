  ...
  return (
    <div className="relative rounded-[2rem] min-h-screen overflow-hidden bg-[#FAF7F0]">
      ...
      <section className="rounded-[2rem] border border-[#2D8A6A]/15 bg-white/90 p-6 shadow-[0_24px_80px_-36px_rgba(13,59,46,0.22)] sm:p-8">
        <p className="text-[11px] font-bold uppercase tracking-[0.24em] text-[#0D5C48]">Parent attendance</p>
        <h1 className="mt-3 font-serif text-3xl font-semibold tracking-tight text-[#063F32] sm:text-4xl">Participation records</h1>
      </section>
      <ChildSwitcher
