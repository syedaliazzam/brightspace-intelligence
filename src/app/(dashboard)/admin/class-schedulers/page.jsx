...
function buildClassSchedulerEvents(item) {
  ...
  if (!startDate || !endDate || !weekdaySet.size) {
    const fallbackStart = parseDateTime(item?.rescheduled_start || item?.scheduled_start || item?.rescheduledStartTime || item?.scheduledStart);
    const fallbackEnd = parseDateTime(item?.rescheduled_end || item?.scheduled_end || item?.rescheduledEndTime || item?.scheduledEnd);
...
export default function AdminUnifiedCalendarPage() {
          ...
          <div className="relative flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-5xl">
              ...
              <p className="mt-3 text-sm leading-7 text-[#EAF6EF] sm:text-base">
                View class schedulers, public events, and internal events in a single calendar.
              </p>
            </div>
