      ...
      {voucher ? (
        <div className="fixed inset-0 z-50 flex items-start justify-center overflow-hidden bg-slate-950/45 px-4 pt-28 pb-10">
          <motion.div
            ...
            className="w-full max-w-2xl max-h-[calc(100vh-6.5rem)] overflow-y-auto rounded-[2rem] border border-white/70 bg-white p-6 shadow-[0_24px_80px_-36px_rgba(15,23,42,0.32)] sm:p-8"
          >
