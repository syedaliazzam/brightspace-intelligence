    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-5">
      {items.map((item, index) => (
        <motion.article
          ...
          className="relative overflow-hidden rounded-[1.75rem] border border-[#2D8A6A]/15 bg-[linear-gradient(180deg,rgba(255,255,255,0.96)_0%,rgba(250,247,240,0.98)_100%)] p-5 shadow-[0_18px_60px_-36px_rgba(13,59,46,0.16)] backdrop-blur-xl"
        >
